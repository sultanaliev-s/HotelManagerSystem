...
namespace HotelManagerSystem.DAL.Migrations
{
    ...
    [Migration("20230526135701_addfirst")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelManagerSystem.Models.Data.HotelServices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HotelManagerSystem.Models.Data.HotelType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HotelManagerSystem.Models.Entities.Hotel", b =>
                {
                    ...
                    b.HasOne("HotelManagerSystem.Models.Data.HotelType", "Type")
                        .WithMany("Hotels")
            ...
            modelBuilder.Entity("HotelManagerSystem.Models.Entities.HotelCategory", b =>
                {
                    b.HasOne("HotelManagerSystem.Models.Data.HotelType", "HotelType")
            ...
            modelBuilder.Entity("HotelManagerSystem.Models.Entities.RoomReservation", b =>
                {
                    b.HasOne("HotelManagerSystem.Models.Entities.Room", "Room")
                        .WithOne("Reservation")
                        .HasForeignKey("HotelManagerSystem.Models.Entities.RoomReservation", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
